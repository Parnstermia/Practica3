...
public class Movs {
    ...
    public static final int INT_MOV_N = 0;
    public static final int INT_MOV_NE = 1;
    public static final int INT_MOV_E = 2;
    public static final int INT_MOV_SE = 3;
    public static final int INT_MOV_S = 4;
    public static final int INT_MOV_SW = 5;
    public static final int INT_MOV_W = 6;
    public static final int INT_MOV_NW = 7;
